...
namespace Basic.MinValue.Tests
{
    class ClosestTests
    {
        ...
        [Category("Loop")]
        public void TestClosest(string testCase)
        {
            Action app = new Action(Closest.Main);
            string result;
            ...
            switch (testCase)
            {
                ...
                case Case4:
                    ...
                    result = app.Run(-19, -87, -45, -41, -96, -41, -21, -45, -80, -21);
                    actual = result.FetchValue<decimal>();
                    expected = 4;
                    Assert.AreEqual(expected, actual);
                    ...
                    result = app.Run(-19, -87, -41, -45, 96, 96, -41, -21, -45, -80);
                    actual = result.FetchValue<decimal>();
                    expected = 0;
                    Assert.AreEqual(expected, actual);
                    break;
